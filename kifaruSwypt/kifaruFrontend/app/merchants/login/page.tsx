...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await api.post("/auth/login", { merchantEmail, password });
      ...
      if (res?.data?.message) {
        ...
        if (token) {
          ...
          const merchant_id = decoded.merchant_id || decoded.sub || "Unknown merchant_id";
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white rounded-3xl p-8 shadow-2xl border border-white/50 backdrop-blur-sm">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">Virtual POS Merchant Login</p>
          </div>
